...
/**
 * Protobuf type {@code grpc.util.MyResponse}
 */
public final class MyResponse extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:grpc.util.MyResponse)
    MyResponseOrBuilder {
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return TimeTestProto.internal_static_grpc_MyResponse_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return TimeTestProto.internal_static_grpc_MyResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            MyResponse.class, Builder.class);
  }

  public static final int DATAGET_FIELD_NUMBER = 1;
  private volatile Object dataget_;
  /**
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (!getDatagetBytes().isEmpty()) {
      com.google.protobuf.GeneratedMessageV3.writeString(output, 1, dataget_);
    }
  ...
  public int getSerializedSize() {
    ...
    size = 0;
    if (!getDatagetBytes().isEmpty()) {
      size += com.google.protobuf.GeneratedMessageV3.computeStringSize(1, dataget_);
    }
  ...
  public boolean equals(final Object obj) {
    ...
    if (!getDataget()
        .equals(other.getDataget())) return false;
  ...
  public int hashCode() {
    ...
    hash = (37 * hash) + DATAGET_FIELD_NUMBER;
    hash = (53 * hash) + getDataget().hashCode();
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:grpc.util.MyResponse)
      MyResponseOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return TimeTestProto.internal_static_grpc_MyResponse_descriptor;
    ...
    // Construct using grpc.util.MyResponse.newBuilder()
    private Builder() {
    ...
    public Builder mergeFrom(MyResponse other) {
      ...
      if (!other.getDataget().isEmpty()) {
        dataget_ = other.dataget_;
        onChanged();
      }
    ...
    /**
     * <code>string dataget = 1;</code>
     * @param value The dataget to set.
     * @return This builder for chaining.
     */
    public Builder setDataget(
        String value) {
      if (value == null) {
    throw new NullPointerException();
  }
     ...
     * @return This builder for chaining.
     */
    public Builder clearDataget() {
      
      dataget_ = getDefaultInstance().getDataget();
      onChanged();
      return this;
    }
    /**
     * <code>string dataget = 1;</code>
     * @param value The bytes for dataget to set.
     * @return This builder for chaining.
     */
    public Builder setDatagetBytes(
  ...
  checkByteStringIsUtf8(value);
    ...
    // @@protoc_insertion_point(builder_scope:grpc.util.MyResponse)
  }

  // @@protoc_insertion_point(class_scope:grpc.util.MyResponse)
